          ...
          <div class="card-body">
            <form method="post">
              <div class="mb-3">
                ...
                <?php if(isset($error)){ ?>
                  <span><i style="color:red; float:right;">Email atau kata sandi salah</i></span>
                <?php } ?>
              ...
              <div class="mb-3 form-check text-center">
                <span>Belum memiliki akun? <a class="text-decoration-none" href="register.php"><b>Daftar disini</b></a>.</span>
              </div>
              <div class="col" style="float:right;">
                <button name="login" class="btn btn-primary" style="width:8rem;">Masuk</button>
